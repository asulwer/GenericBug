...
namespace GenericBug.Core.Util.Storage.ZipStorage.Zip
{
    ...
    public class SelfExtractorSaveOptions
    {
        ...
        /// </para>
        /// </remarks>
        public GenericBug.Core.Util.Storage.ZipStorage.Zip.ExtractExistingFileAction ExtractExistingFile
        {
            get;
            set;
        }
    ...
    partial class ZipFile
    {
        ...
        private static ExtractorSettings[] SettingsList = {
            new ExtractorSettings() {
                ...
                CopyThroughResources = new List<string>{
                    "GenericBug.Core.Util.Storage.ZipStorage.Zip.WinFormsSelfExtractorStub.resources",
                    "GenericBug.Core.Util.Storage.ZipStorage.Zip.Forms.PasswordDialog.resources",
                    "GenericBug.Core.Util.Storage.ZipStorage.Zip.Forms.ZipContentsDialog.resources"},
        ...
        //         "namespace GenericBug.Core.Util.Storage.ZipStorage.Zip { public partial class WinFormsSelfExtractorStub { partial void _SetDefaultExtractLocation() {" +
        ...
        private void _SaveSfxStub(string exeToGenerate, SelfExtractorSaveOptions options)
        {
            ...
            try
            {
                ...
                // get the GenericBug.Core.Util.Storage.ZipStorage.Zip assembly
                ...
                using (var csharp = new Microsoft.CSharp.CSharpCodeProvider())
                {
                    ...
                    // This is the list of referenced assemblies.  GenericBug.Core.Util.Storage.ZipStorage.Zip is
                    ...
                    using (ZipFile zip = ZipFile.Read(a2.GetManifestResourceStream("GenericBug.Core.Util.Storage.ZipStorage.Zip.Resources.ZippedResources.zip")))
                    {
                        ...
                        {
                            // Use the ico file that is embedded into the GenericBug.Core.Util.Storage.ZipStorage.Zip
                        ...
                        // add the GenericBug.Core.Util.Storage.ZipStorage.Utils.Zip DLL as an embedded resource
