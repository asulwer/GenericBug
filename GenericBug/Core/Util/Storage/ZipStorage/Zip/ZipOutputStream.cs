...
// generating zip files.  This class does not depend on GenericBug.Core.Util.Storage.ZipStorage.Zip.ZipFile, but rather
...
namespace GenericBug.Core.Util.Storage.ZipStorage.Zip
{
    ...
    public class ZipOutputStream : Stream
    {
        ...
        private void _Init(Stream stream, bool leaveOpen, string name)
        {
            ...
            Strategy = GenericBug.Core.Util.Storage.ZipStorage.Zlib.CompressionStrategy.Default;
            _name = name ?? "(stream)";
#if !NETCF
        ...
        ///   cref="GenericBug.Core.Util.Storage.ZipStorage.Zlib.CompressionStrategy "/>.
        /// </remarks>
        ...
        public bool UseUnicodeAsNecessary
        {
            ...
            set
            {
                ...
                {
                    _alternateEncoding = GenericBug.Core.Util.Storage.ZipStorage.Zip.ZipOutputStream.DefaultEncoding;
        ...
        ///     cref="GenericBug.Core.Util.Storage.ZipStorage.Zlib.CompressionLevel.BestSpeed"/>.  You may have to perform
        ...
        private GenericBug.Core.Util.Storage.ZipStorage.Crc.CrcCalculatorStream _entryOutputStream;
...
#if !NETCF
        public GenericBug.Core.Util.Storage.ZipStorage.Zlib.ParallelDeflateOutputStream ParallelDeflater
        {
            get
            {
