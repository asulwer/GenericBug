...
namespace GenericBug.Core.Util.Storage.ZipStorage.Zip
{
    ...
    public partial class ZipEntry
    {
        ...
        ///
        /// <seealso cref="GenericBug.Core.Util.Storage.ZipStorage.Zip.ZipEntry.ExtractExistingFile"/>
        /// <seealso cref="GenericBug.Core.Util.Storage.ZipStorage.Zip.ZipEntry.Extract(string, ExtractExistingFileAction)"/>
        ///
        /// <example>
        ...
        ///
        /// <seealso cref="GenericBug.Core.Util.Storage.ZipStorage.Zip.ZipEntry.ExtractExistingFile"/>
        /// <seealso cref="GenericBug.Core.Util.Storage.ZipStorage.Zip.ZipEntry.ExtractWithPassword(ExtractExistingFileAction, string)"/>
        ///
        /// <remarks>
        ///
        /// <para>
        ...
        ///   cref="GenericBug.Core.Util.Storage.ZipStorage.Zip.ZipEntry.ExtractExistingFile"/>property, or call
        ///   <see
        ...
        ///
        /// <seealso cref="GenericBug.Core.Util.Storage.ZipStorage.Zip.ZipEntry.ExtractExistingFile"/>
        /// <seealso cref="GenericBug.Core.Util.Storage.ZipStorage.Zip.ZipEntry.ExtractWithPassword(string, ExtractExistingFileAction, string)"/>
        ///
        /// <remarks>
        /// <para>
        ///   Existing entries in the filesystem will not be overwritten. If you
        ...
        ///   cref="GenericBug.Core.Util.Storage.ZipStorage.Crc.CrcCalculatorStream"/>.  Use it as you would any
        ...
        ///   cref="GenericBug.Core.Util.Storage.ZipStorage.Crc.CrcCalculatorStream.Crc"/> property on the
        ...
        ///   using (GenericBug.Core.Util.Storage.ZipStorage.Zlib.CrcCalculatorStream s = e1.OpenReader())
        ///   {
        ...
        ///       Using s As GenericBug.Core.Util.Storage.ZipStorage.Zlib.CrcCalculatorStream = e1.OpenReader
        ///           Dim n As Integer
        ...
        /// </code>
        /// </example>
        /// <seealso cref="GenericBug.Core.Util.Storage.ZipStorage.Zip.ZipEntry.Extract(System.IO.Stream)"/>
        /// <returns>The Stream for reading.</returns>
        public GenericBug.Core.Util.Storage.ZipStorage.Crc.CrcCalculatorStream OpenReader()
        {
            // workitem 10923
        ...
        /// <param name="password">The password to use for decrypting the entry.</param>
        /// <returns>The Stream for reading.</returns>
        public GenericBug.Core.Util.Storage.ZipStorage.Crc.CrcCalculatorStream OpenReader(string password)
        {
            // workitem 10923
            if (_container.ZipFile == null)
                throw new InvalidOperationException("Use OpenReader() only with ZipFile.");
        ...
        internal GenericBug.Core.Util.Storage.ZipStorage.Crc.CrcCalculatorStream InternalOpenReader(string password)
        {
            ValidateCompression();
            ValidateEncryption();
            ...
            return new GenericBug.Core.Util.Storage.ZipStorage.Crc.CrcCalculatorStream(input3, LeftToRead);
        }
        ...
        internal void CalcWinZipAesMac(Stream input)
        {
                ...
                Encryption == EncryptionAlgorithm.WinZipAes256)
            {
                ...
                else if (input is GenericBug.Core.Util.Storage.ZipStorage.Zlib.CrcCalculatorStream)
                {
                    xxx;
                }
        ...
        private Int32 ExtractOne(Stream output)
        {
            ...
            try
            {
                ...
                // workitem 10178
                GenericBug.Core.Util.Storage.ZipStorage.Zip.SharedUtilities.Workaround_Ladybug318918(input);
                ...
                using (var s1 = new GenericBug.Core.Util.Storage.ZipStorage.Crc.CrcCalculatorStream(input3))
                {
                    while (LeftToRead > 0)
                    {
        ...
        internal Stream GetExtractDecompressor(Stream input2)
        {
            ...
            switch (_CompressionMethod_FromZipFile)
            {
                ...
                case (short)CompressionMethod.Deflate:
                    return new GenericBug.Core.Util.Storage.ZipStorage.Zlib.DeflateStream(input2, GenericBug.Core.Util.Storage.ZipStorage.Zlib.CompressionMode.Decompress, true);
#if BZIP
                case (short)CompressionMethod.BZip2:
                    return new GenericBug.Core.Util.Storage.ZipStorage.BZip2.BZip2InputStream(input2, true);
#endif
            }
        ...
        internal void _SetTimes(string fileOrDirectory, bool isFile)
        {
            ...
            try
            {
                ...
                {
                    // workitem 6191
                    DateTime AdjustedLastModified = GenericBug.Core.Util.Storage.ZipStorage.Zip.SharedUtilities.AdjustTime_Reverse(LastModified);
