...
namespace GenericBug.Core.Util.Storage.ZipStorage.Zip
{
    ...
    public partial class ZipEntry
    {
        ...
        public ZipEntry()
        {
            ...
            _CompressionLevel = GenericBug.Core.Util.Storage.ZipStorage.Zlib.CompressionLevel.Default;
        ...
        public DateTime LastModified
        {
            ...
            set
            {
                _LastModified = (value.Kind == DateTimeKind.Unspecified)
                    ...
                    : value.ToLocalTime();
                _Mtime = GenericBug.Core.Util.Storage.ZipStorage.Zip.SharedUtilities.AdjustTime_Reverse(_LastModified).ToUniversalTime();
        ...
        /// <seealso cref="GenericBug.Core.Util.Storage.ZipStorage.Zip.ZipEntry.LastModified"/>
        ...
        public CompressionMethod CompressionMethod
        {
            ...
            set
            {
                ...
                if (_CompressionMethod == (Int16)GenericBug.Core.Util.Storage.ZipStorage.Zip.CompressionMethod.None)
                    _CompressionLevel = GenericBug.Core.Util.Storage.ZipStorage.Zlib.CompressionLevel.None;
                else if (CompressionLevel == GenericBug.Core.Util.Storage.ZipStorage.Zlib.CompressionLevel.None)
                    _CompressionLevel = GenericBug.Core.Util.Storage.ZipStorage.Zlib.CompressionLevel.Default;
        ...
        public GenericBug.Core.Util.Storage.ZipStorage.Zlib.CompressionLevel CompressionLevel
        {
            ...
            set
            {
                ...
                if (value == GenericBug.Core.Util.Storage.ZipStorage.Zlib.CompressionLevel.Default &&
                    _CompressionMethod == (short)CompressionMethod.Deflate) return; // nothing to do
                _CompressionLevel = value;

                if (value == GenericBug.Core.Util.Storage.ZipStorage.Zlib.CompressionLevel.None &&
                    _CompressionMethod == (short)CompressionMethod.None)
                    return; // nothing more to do

                if (_CompressionLevel == GenericBug.Core.Util.Storage.ZipStorage.Zlib.CompressionLevel.None)
                    _CompressionMethod = (short) GenericBug.Core.Util.Storage.ZipStorage.Zip.CompressionMethod.None;
                else
                    _CompressionMethod = (short) GenericBug.Core.Util.Storage.ZipStorage.Zip.CompressionMethod.Deflate;
        ...
        /// </remarks>
        ///
        /// <seealso cref="GenericBug.Core.Util.Storage.ZipStorage.Zip.ZipEntry.UncompressedSize"/>
        ...
        /// </remarks>
        ///
        /// <seealso cref="GenericBug.Core.Util.Storage.ZipStorage.Zip.ZipEntry.CompressedSize"/>
        ...
        /// </example>
        ///
        /// <seealso cref="GenericBug.Core.Util.Storage.ZipStorage.Zip.ZipEntry.Encryption"/>
        ...
        ///
        /// </remarks>
        /// <seealso cref="GenericBug.Core.Util.Storage.ZipStorage.Zip.ZipFile.ExtractExistingFile"/>
        ///
        /// <example>
        ...
        ///
        /// </remarks>
        /// <seealso cref="GenericBug.Core.Util.Storage.ZipStorage.Zip.ZipFile.ZipErrorAction"/>
        ...
        public bool UseUnicodeAsNecessary
        {
            ...
            set
            {
                ...
                {
                    AlternateEncoding = GenericBug.Core.Util.Storage.ZipStorage.Zip.ZipFile.DefaultEncoding;
                    AlternateEncodingUsage = ZipOption.Never;
                }
            }
        }
        ...
        private static ZipEntry Create(string nameInArchive, ZipEntrySource source, Object arg1, Object arg2)
        {
            if (String.IsNullOrEmpty(nameInArchive))
                throw new GenericBug.Core.Util.Storage.ZipStorage.Zip.ZipException("The entry name must be non-null and non-empty.");
            ...
            else
            {
                ...
                if (String.IsNullOrEmpty(filename))
                    throw new GenericBug.Core.Util.Storage.ZipStorage.Zip.ZipException("The filename must be non-null and non-empty.");
...
#if NETCF
                    // workitem 6878
                    // GenericBug.Core.Util.Storage.ZipStorage.Zip.SharedUtilities.AdjustTime_Win32ToDotNet
        ...
        private void SetFdpLoh()
        {
            ...
            try
            {
                ...
                // workitem 10178
                GenericBug.Core.Util.Storage.ZipStorage.Zip.SharedUtilities.Workaround_Ladybug318918(this.ArchiveStream);
            }
        ...
        private GenericBug.Core.Util.Storage.ZipStorage.Zlib.CompressionLevel _CompressionLevel;
