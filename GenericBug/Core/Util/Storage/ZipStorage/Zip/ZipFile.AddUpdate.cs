...
namespace GenericBug.Core.Util.Storage.ZipStorage.Zip
{
    public partial class ZipFile
    {
        ...
        /// </remarks>
        ///
        /// <seealso cref="GenericBug.Core.Util.Storage.ZipStorage.Zip.ZipFile.AddFile(string)"/>
        /// <seealso cref="GenericBug.Core.Util.Storage.ZipStorage.Zip.ZipFile.AddDirectory(string)"/>
        /// <seealso cref="GenericBug.Core.Util.Storage.ZipStorage.Zip.ZipFile.UpdateItem(string)"/>
        ///
        ...
        /// </param>
        ///
        /// <seealso cref="GenericBug.Core.Util.Storage.ZipStorage.Zip.ZipFile.AddFile(string, string)"/>
        /// <seealso cref="GenericBug.Core.Util.Storage.ZipStorage.Zip.ZipFile.AddDirectory(string, string)"/>
        /// <seealso cref="GenericBug.Core.Util.Storage.ZipStorage.Zip.ZipFile.UpdateItem(string, string)"/>
        ///
        /// <example>
        ...
        /// <overloads>This method has two overloads.</overloads>
        ///
        /// <seealso cref="GenericBug.Core.Util.Storage.ZipStorage.Zip.ZipFile.AddItem(string)"/>
        /// <seealso cref="GenericBug.Core.Util.Storage.ZipStorage.Zip.ZipFile.AddDirectory(string)"/>
        /// <seealso cref="GenericBug.Core.Util.Storage.ZipStorage.Zip.ZipFile.UpdateFile(string)"/>
        ///
        /// <param name="fileName">
        ...
        /// </example>
        ///
        /// <seealso cref="GenericBug.Core.Util.Storage.ZipStorage.Zip.ZipFile.AddItem(string,string)"/>
        /// <seealso cref="GenericBug.Core.Util.Storage.ZipStorage.Zip.ZipFile.AddDirectory(string, string)"/>
        /// <seealso cref="GenericBug.Core.Util.Storage.ZipStorage.Zip.ZipFile.UpdateFile(string,string)"/>
        ///
        /// <param name="fileName">
        ...
        /// </param>
        ///
        /// <seealso cref="GenericBug.Core.Util.Storage.ZipStorage.Zip.ZipFile.SelectEntries(String)" />
        ...
        /// </example>
        ///
        /// <seealso cref="GenericBug.Core.Util.Storage.ZipStorage.Zip.ZipFile.AddSelectedFiles(String, String)" />
        ...
        ///
        /// <seealso cref="GenericBug.Core.Util.Storage.ZipStorage.Zip.ZipFile.AddFile(string)"/>
        /// <seealso cref="GenericBug.Core.Util.Storage.ZipStorage.Zip.ZipFile.UpdateDirectory(string)"/>
        /// <seealso cref="GenericBug.Core.Util.Storage.ZipStorage.Zip.ZipFile.UpdateItem(string)"/>
        ///
        /// <param name="fileName">
        ...
        ///
        /// <seealso cref="GenericBug.Core.Util.Storage.ZipStorage.Zip.ZipFile.AddFile(string,string)"/>
        /// <seealso cref="GenericBug.Core.Util.Storage.ZipStorage.Zip.ZipFile.UpdateDirectory(string,string)"/>
        /// <seealso cref="GenericBug.Core.Util.Storage.ZipStorage.Zip.ZipFile.UpdateItem(string,string)"/>
        ///
        /// <param name="fileName">
        ///   The name of the file to add or update. It should refer to a file in the
        ...
        /// </example>
        ///
        /// <seealso cref="GenericBug.Core.Util.Storage.ZipStorage.Zip.ZipFile.UpdateEntry(string, System.IO.Stream)"/>
        ///
        /// <param name="entryName">
        ...
        ///
        /// using(GenericBug.Core.Util.Storage.ZipStorage.Zip.ZipFile zip = new GenericBug.Core.Util.Storage.ZipStorage.Zip.ZipFile())
        /// {
        ...
        /// </remarks>
        ///
        /// <seealso cref="GenericBug.Core.Util.Storage.ZipStorage.Zip.ZipFile.AddEntry(string, System.IO.Stream)"/>
        /// <seealso cref="GenericBug.Core.Util.Storage.ZipStorage.Zip.ZipEntry.InputStream"/>
        ///
        /// <param name="entryName">
        ///   The name, including any path, to use within the archive for the entry.
        /// </param>
