...
namespace GenericBug.Core.Util.Storage.ZipStorage.Zip
{
    ...
    partial class ZipFile
    {
                                               ...
                                               bool wantUpdate)
        {
            ...
            GenericBug.Core.Util.Storage.ZipStorage.FileSelector ff = new GenericBug.Core.Util.Storage.ZipStorage.FileSelector(selectionCriteria,
...
namespace GenericBug.Core.Util.Storage.ZipStorage
{
    internal abstract partial class SelectionCriterion
    {
        internal abstract bool Evaluate(GenericBug.Core.Util.Storage.ZipStorage.Zip.ZipEntry entry);
    }


    internal partial class NameCriterion : SelectionCriterion
    {
        internal override bool Evaluate(GenericBug.Core.Util.Storage.ZipStorage.Zip.ZipEntry entry)
        {
    ...
    {
        private bool Evaluate(GenericBug.Core.Util.Storage.ZipStorage.Zip.ZipEntry entry)
        {
        ...
        public ICollection<GenericBug.Core.Util.Storage.ZipStorage.Zip.ZipEntry> SelectEntries(GenericBug.Core.Util.Storage.ZipStorage.Zip.ZipFile zip)
        {
            if (zip == null)
                throw new ArgumentNullException("zip");

            var list = new List<GenericBug.Core.Util.Storage.ZipStorage.Zip.ZipEntry>();

            foreach (GenericBug.Core.Util.Storage.ZipStorage.Zip.ZipEntry e in zip)
            {
                if (this.Evaluate(e))
                    list.Add(e);
            }
        ...
        ///
        /// <returns>a collection of ZipEntry objects that conform to the criteria.</returns>
        public ICollection<GenericBug.Core.Util.Storage.ZipStorage.Zip.ZipEntry> SelectEntries(GenericBug.Core.Util.Storage.ZipStorage.Zip.ZipFile zip, string directoryPathInArchive)
        {
            if (zip == null)
                throw new ArgumentNullException("zip");
