...
namespace GenericBug.Core.Util.Storage.ZipStorage.BZip2
{
    ...
    ///
    /// <para>
    ///   This class is similar to <see cref="GenericBug.Core.Util.Storage.ZipStorage.BZip2.BZip2OutputStream"/>,
    ...
    /// </para>
    ///
    /// <seealso cref="GenericBug.Core.Util.Storage.ZipStorage.BZip2.BZip2OutputStream" />
    public class ParallelBZip2OutputStream : System.IO.Stream
    {
        ...
        ///       {
        ///           using (var compressor = new GenericBug.Core.Util.Storage.ZipStorage.BZip2.ParallelBZip2OutputStream(output))
        ///           {
