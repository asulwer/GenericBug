...
// reading zip files.  This class does not depend on GenericBug.Core.Util.Storage.ZipStorage.Zip.ZipFile, but rather
    ...
    public class ZipInputStream : Stream
    {
        ...
        public override int Read(byte[] buffer, int offset, int count)
        {
            ...
            if (_LeftToRead == 0)
            {
                ...
                // workitem 10178
                GenericBug.Core.Util.Storage.ZipStorage.Zip.SharedUtilities.Workaround_Ladybug318918(_inputStream);
            }
        ...
        private GenericBug.Core.Util.Storage.ZipStorage.Crc.CrcCalculatorStream _crcStream;
