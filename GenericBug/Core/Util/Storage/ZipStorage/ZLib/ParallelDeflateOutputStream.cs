...
using GenericBug.Core.Util.Storage.ZipStorage.Zlib;
using System.IO;


namespace GenericBug.Core.Util.Storage.ZipStorage.Zlib
{
    internal class WorkItem
    {
        ...
        public WorkItem(int size,
                        GenericBug.Core.Util.Storage.ZipStorage.Zlib.CompressionLevel compressLevel,
    ...
    ///
    /// <para>
    ///   This class is similar to <see cref="GenericBug.Core.Util.Storage.ZipStorage.Zlib.DeflateStream"/>, except
    ...
    ///
    /// </remarks>
    /// <seealso cref="GenericBug.Core.Util.Storage.ZipStorage.Zlib.DeflateStream" />
    public class ParallelDeflateOutputStream : System.IO.Stream
    {
        ...
        private int                         _Crc32;
        private GenericBug.Core.Util.Storage.ZipStorage.Crc.CRC32             _runningCrc;
        ...
        private GenericBug.Core.Util.Storage.ZipStorage.Zlib.CompressionLevel _compressLevel;
        ...
        ///
        /// <para>
        ///   This class is similar to <see cref="GenericBug.Core.Util.Storage.ZipStorage.Zlib.DeflateStream"/>,
        ...
        ///   cref="GenericBug.Core.Util.Storage.ZipStorage.Zlib.DeflateStream"/>.  On the other hand, using a
        ...
        private void _InitializePoolOfWorkItems()
        {
            ...
            _runningCrc = new GenericBug.Core.Util.Storage.ZipStorage.Crc.CRC32();
            _currentlyFilling = -1;
            _lastFilled = -1;
            _lastWritten = -1;
            _latestCompressed = -1;
        ...
        ///
        /// <para>
        ///   To decompress data, use the <see cref="GenericBug.Core.Util.Storage.ZipStorage.Zlib.DeflateStream"/> class.
        /// </para>
        ///
        /// </remarks>
        ...
        private void _PerpetualWriterMethod(object state)
        {
            ...
            try
            {
                do
                {
                    ...
                    GenericBug.Core.Util.Storage.ZipStorage.Zlib.CRC32 c= new GenericBug.Core.Util.Storage.ZipStorage.Zlib.CRC32();
                    do
                    {
        ...
        private void _DeflateOne(Object wi)
        {
            ...
            try
            {
                ...
                GenericBug.Core.Util.Storage.ZipStorage.Crc.CRC32 crc = new GenericBug.Core.Util.Storage.ZipStorage.Crc.CRC32();
