...
// compile: msbuild
// not: csc.exe /t:library /debug+ /out:GenericBug.Core.Util.Storage.ZipStorage.BZip2.dll BZip2InputStream.cs BCRC32.cs Rand.cs
...
namespace GenericBug.Core.Util.Storage.ZipStorage.BZip2
{
    ...
    public class BZip2InputStream : System.IO.Stream
    {
        ...
        private int bsBuff;
        private int bsLive;
        private readonly GenericBug.Core.Util.Storage.ZipStorage.Crc.CRC32 crc = new GenericBug.Core.Util.Storage.ZipStorage.Crc.CRC32(true);
        private int nInUse;
        ...
        ///   {
        ///       using (var decompressor = new GenericBug.Core.Util.Storage.ZipStorage.BZip2.BZip2InputStream(fs))
        ///       {
