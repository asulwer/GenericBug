...
namespace GenericBug.Core.Util.Storage.ZipStorage.Zip
{
    ...
    internal class WinZipAesCrypto
    {
            ...
            set
            {
                ...
                if (_Password != null)
                {
                    ...
                    if (PasswordVerificationGenerated != PasswordVerificationStored)
                        throw new GenericBug.Core.Util.Storage.ZipStorage.Zip.BadPasswordException();
                }
            }
            private get
            {
        ...
        public void ReadAndVerifyMac(System.IO.Stream s)
        {
            ...
            if (invalid)
                throw new GenericBug.Core.Util.Storage.ZipStorage.Zip.BadStateException("The MAC does not match.");
        }
