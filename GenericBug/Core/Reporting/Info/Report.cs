...
namespace GenericBug.Core.Reporting.Info
{
	...
	public class Report
	{
		...
		public Report(SerializableException serializableException)
		{
		...
		/// <see cref="GenericBug.Settings.ProcessingException"/> event to fill this property with required information. 
		/// </summary>
