...
namespace GenericBug.Core.Util.Storage.ZipStorage
{
    ...
    ///   cref="GenericBug.Core.Util.Storage.ZipStorage.Zip.ZipFile.AddSelectedFiles(String,String)"/> method, or one of
    ///   its overloads, is called.  It's also used for the <see
    ///   cref="GenericBug.Core.Util.Storage.ZipStorage.Zip.ZipFile.ExtractSelectedEntries(String)"/> methods.  Typically, an
