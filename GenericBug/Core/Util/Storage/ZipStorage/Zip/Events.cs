...
namespace GenericBug.Core.Util.Storage.ZipStorage.Zip
{
    ...
    ///   cref="GenericBug.Core.Util.Storage.ZipStorage.Zip.ZipFile.AddEntry(string, WriteDelegate)"/>, the application
    ...
    /// </code>
    /// </example>
    /// <seealso cref="GenericBug.Core.Util.Storage.ZipStorage.Zip.ZipFile.AddEntry(string, WriteDelegate)"/>
    ...
    ///
    /// <remarks>
    ///   When you add an entry via <see cref="GenericBug.Core.Util.Storage.ZipStorage.Zip.ZipFile.AddEntry(string,
    ...
    /// </remarks>
    ///
    /// <seealso cref="GenericBug.Core.Util.Storage.ZipStorage.Zip.ZipFile.AddEntry(string, OpenDelegate, CloseDelegate)"/>
    ...
    /// </para>
    /// </remarks>
    /// <seealso cref="GenericBug.Core.Util.Storage.ZipStorage.Zip.ZipFile.SetCompression"/>
    public delegate GenericBug.Core.Util.Storage.ZipStorage.Zlib.CompressionLevel SetCompressionCallback(string localFileName, string fileNameInArchive);
